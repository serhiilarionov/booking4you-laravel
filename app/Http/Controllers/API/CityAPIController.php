...
class CityAPIController extends AppBaseController
{
    ...
    public function store(CreateCityAPIRequest $request)
    {
        ...
        return $this->sendResponse($cities, 'City saved successfully');
    }
    ...
    public function show($id)
    {
        ...
        if (empty($city)) {
            return Response::json(ResponseUtil::makeError('City not found'), 404);
        }
    ...
    {
        /** @var City $city */
        $city = $this->cityRepository->skipPresenter()->find($id);
