...
class CountryAPIController extends AppBaseController
{
    ...
    public function __construct(CountryRepository $countryRepo)
    {
        ...
        $this->countryRepository->skipPresenter(false);
    }
    ...
    public function store(CreateCountryAPIRequest $request)
    {
        ...
        return $this->sendResponse($countries, 'Country saved successfully');
    }
    ...
    {
        /** @var Country $country */
        $country = $this->countryRepository->skipPresenter()->find($id);
